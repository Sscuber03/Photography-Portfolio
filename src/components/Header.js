...
const Header = () => {
  ...
  return (
    <header className={'fixed w-full px-[30px] lg:px-[100px] z-30 h-[100px] lg:h-[140px] flex items-center xl:bg-transparent '+(color ? 'bg-transparent' : 'bg-blue-100')}>
      <div className='flex flex-col lg:flex-row lg:items-center w-full justify-between'>
        {/* Logo */}
        <Link to={'/'} className='max-w-[200px] my-auto'>
          <img src={Logo} alt='' />
        </Link>
